...
```bash
# 내 컴퓨터(localhost) 전용으로 켜기
npm run dev

# 💡 사내망 다른 PC/스마트폰에서도 IP(예: http://10.10.5.56:3000)로 접속 가능하게 켜기
npm run dev:host
```

✨ 이제 웹 브라우저 주소창에 **`http://localhost:3000`** 또는 사내 IP **`http://10.10.5.56:3000`** 을 치고 들어오시면 됩니다!
